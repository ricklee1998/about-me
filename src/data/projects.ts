...
export const projects: Project[] = [
  ...
  // ────────────────── 라이너스 ──────────────────
  {
    ...
    achievements: [
      'LMS와 LXP가 데이터 구조를 공유해 두 제품이 학사 데이터를 단절 없이 사용',
  ...
  },
  {
    ...
    features: [
      {
        title: '단축번호 → 페이지 연결',
        body:
          '구매된 단축번호에 따라 기업 페이지·이벤트 페이지·외부 링크 등 어디로 보낼지 결정되는 라우팅 구조. 기업·이벤트와 단축번호를 연결하는 것이 서비스의 핵심입니다.',
      },
      {
        title: '운영자 어드민',
        body:
    ...
    responsibilities: [
      ...
      '단축번호와 기업·이벤트 페이지를 연결하는 라우팅 구조 설계',
      '기업 페이지·콘텐츠·회원 전용 페이지 운영 구조 개발',
      '할인·이벤트 콘텐츠 화면 구현, API 설계',
      'iOS/Android 디바이스, SKT 망 환경 테스트',
    ],
    achievements: [
      '기업·이벤트와 단축번호를 연결하는 서비스를 백엔드·프론트엔드·어드민까지 풀스택으로 개발',
      '단축번호 발신만으로 해당 기업·이벤트 페이지로 이어지는 사용자 흐름 구현',
  ...
  // ────────────────── 대학 ──────────────────
  {
    ...
    features: [
      ...
      },
      {
        title: 'PDF 회의록 자동 생성',
        body:
          '회의가 끝나면 회의록 형식의 PDF를 한 번에 내보낼 수 있습니다. 트리별로 별도 PDF 추출 가능.',
      },
      {
    ...
    responsibilities: [
      ...
      '트리 보드 UI — 블록 추가·삭제·이동·다중 선택, 트리 간 이동',
      '회의록 PDF 추출 기능 — 트리별 회의록 형식 정리',
    ...
    achievements: [
      ...
      '실시간 통신·동기화와 협업 기능을 직접 다뤄본 경험의 출발점',
    ],
    stack: [
      'React',
      'Tailwind CSS',
